...
type Input = { type: string; prompt: string }
...
type NonExpandableInput = BooleanInput | ColorInput | DropdownInput | DropdownMultiInput | SliderInput | StringInput
...
type AnyInput = MandatoryInput | OptionalInput
